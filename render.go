...
2. Мы просим вас пролайкать посты ваших коллег и добавить их в контакты, чтобы повысить охват. Лайкать/добавлять или нет остается на ваше усмотрение. Здесь выведены ссылки с наименьшим количеством кликов на данный момент:%s

3. Затем нажать кнопочку "Добавить ссылку" и вам будет предложено ввести ссылку на пост из пункта 1. Для удобства отображения и подсчета количества кликов мы используем свой сокращатель ссылок
