...
3. Затем нажать кнопочку "Добавить ссылку" и вам будет предложено ввести ссылку на пост из пункта 1. Для отображения и подсчета количества кликов мы используем свой сокращатель ссылок
